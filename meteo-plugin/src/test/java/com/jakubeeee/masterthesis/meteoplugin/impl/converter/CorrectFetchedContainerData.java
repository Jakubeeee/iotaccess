...
public class CorrectFetchedContainerData {

    public static final FetchedContainer EMPTY_CONTAINER = container();

    public static final FetchedContainer CORRECT_SINGLE_FRAGMENT_SINGLE_VALUE_CONTAINER;
    ...
    public static final FetchedContainer CORRECT_SINGLE_FRAGMENT_ALL_VALUES_CONTAINER;
    ...
    public static final FetchedContainer CORRECT_MULTIPLE_FRAGMENT_SINGLE_VALUE_CONTAINER;
    ...
    public static final FetchedContainer CORRECT_MULTIPLE_FRAGMENT_ALL_VALUES_CONTAINER;
